...
class CueWidget(QWidget):
    ...
    def _updateStyle(self, stylesheet):
        self.nameButton.setStyleSheet(stylesheet + " background-image: url('lisp/ui/icons/lisp/Cues/" + self._cue.icon + "-cart.svg'); background-position: center; background-repeat: no-repeat;")
